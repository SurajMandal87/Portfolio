...
function Data() {
    return (
        <div className="home_data">
            ...
            <div className="typing_statement ">
                I am a <Typer />
            </div>{" "}
            <p className="home_description">
                {" "}
                I’ m a software developer and here is my portfolio website.Have a look
                at my journey as a software developer and all of my project works to
                learn more about me.{" "}
            </p>
